...
word1 = reverse ("lanoi" ++ "tcnuF")    -- "++"concatenates strings
...
-- and write it here: 
-- Basically . applies functions one after the other, effectively composing them together. The example shows how to incr the result of the second incr.
